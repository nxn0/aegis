...
Wav2Vec2 is sometimes casually called a "wav2rec" model, but the architecture used here is Wav2Vec2. "Wav2Vec" refers to the waveform-to-vector representation learning family; this particular checkpoint is a Wav2Vec2 sequence classifier fine-tuned for spoof/deepfake detection, not a speech-to-text recognizer.
